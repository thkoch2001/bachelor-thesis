...
% JAX-RS versteht unter Resource class something else: 
% JAX-RS uses annotations in the Resource class to bind it to an URI
% (@Path) and to different Mediatypes (@Produces, @Consumes).
