...
\subsubsection{Media entries included or linked}
...
client however is not allowed to use an inline resource representation as the
...
Atom feed does not contain an ETag for an inlined resource. A client thus can
...
apply this modifications during the next synchronization. TODO
