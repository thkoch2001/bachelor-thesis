...
even the full opensearch description document as shown in figure
\ref{opensearch}. This allows a client to directly search a collection without
the need to get the feed first.
...
% @TODO ich würde irgendwie auch erwarten, dass ich eine Übersicht über die
