...
\label{sec:microdata}
TODO Microformats could also be useful to markup data elements in a (X)HTML
summmary of an Atom entry. In this case a web client could use the data from the
summary in a tabular view without fetching the full enclosed data in case it is
not contained in the content tag.
