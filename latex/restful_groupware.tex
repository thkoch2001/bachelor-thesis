...
% Server site search - No. Google is also not part of the Web stack!
% Access Control 
...
Versioning and Locking, which are provided by WebDAV are not a
requirement. Optimistic locking as provided by ``conditional'' put requests in
HTTP is preferred first because it is an already widespread standard.
