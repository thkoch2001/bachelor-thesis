...
\title{Development of a REST API for the free software Groupware Kolab with support for different Media Types}
...
In summary, for Collection+JSON to become usable as a JSON variant of the
proposed synchronization model, it would need the following simple enhancements:
