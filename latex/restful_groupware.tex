...
The standard lists the supposed features of CardDAV\cite[sec. 1]{RFC6352}:
...
source code. This could have several advantages\footnote{Dispatching in Restlet
  can be programmed
  \citeurl{http://wiki.restlet.org/docs_2.1/13-restlet/27-restlet/326-restlet.html}{2012-2-6}. An
  API for Jersey 2.0 is in
  development. \citeurl{http://java.net/jira/browse/JERSEY-842}{2012-2-6}}:
