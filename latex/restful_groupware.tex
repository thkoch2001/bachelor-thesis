...
the proposal of a competing API to an already widely adopted one. The following
paragraphs quote rules from Fieldings critique and explain how they are violated
by OpenSocial.
...
\begin{table}[tbh]
  ...
  HTML5 Browser &  5 MB & 56 kbit/s & JSON & workplace, internet cafe\\
...
OpenSocial~(~\ref{sec:opensocial-background}) case shows. It is also the primary use case
