...
das ist ein Punkt, denn man in der Related work erwähnen kann, aber das 
ist kein Gliederungspunkt
...
gehört in einen Anforderungsabschnitt
...
*** Konzept und Lösungsidee Entwurf
...
das hier ist jetzt schon das vorstellen einer möglichen Lösung und fällt 
eher in den Bereich Entwurf
...
HTML als weiteren Medientypen ist auch Anforderung und/oder Entwurfsthema
...
wie sehr relevant für deine Implementierung? Aber ansonsten eben ein 
Detail im HTML-Abschnitt
...
Entwurfs oder Implementierungsthema
...
**** Gesammtübersicht über Implementierung
...
>   implementiert werden und ist auf das Konzept eines Updatefeeds 
> spezialiesiert.

das sind alles Implementierungsteile die man erwähnen sollte, aber der 
Leser braucht auf jedenfall einen Gesamtüberblick über die 
Implementierung und deren Architektur, vllcht würde es helfen mal etwas 
von den konkreten Themen loszulassen für die Gliederung und etwas 
allgemeiner zu überlegen, wie so eine Gliederung oder Arbeit aussehen 
würde und was man wo erwartet
...
**** Gedanken zu Medientyplibraries


>   Gedanken zu Libraries für Medientypen: (macht das Sinn?)

würde ich eher als Ausblick sehen und nur kurz andiskutieren
...
**** Hypermediabetrachtung
 in einen ganz eigenen Abschnitt eher gegen Ende 
der Arbeit, da könnte man zB super über (stark/schwach) zusammenhängende 
Graphen von Ressourcen/Medientypen reden
